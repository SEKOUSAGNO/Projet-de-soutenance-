...
/*=========================================
= Récupérer l'id du recruteur entreprise
=========================================*/
...
if (pg_num_rows($resultRecruteur) == 0) {
    ...
    die("Votre profil entreprise n'existe pas.");
...
$mode_candidature = "Plateforme";


// Pas d'email pour ce mode

$email_reception = NULL;
...
/*=========================================
= Enregistrement dans la table offre
=========================================*/
...
alert('Offre publiée avec succès sur la plateforme.');
